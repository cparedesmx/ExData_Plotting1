...
# Set a 2 x 2 array of plots in the device
par(mfrow = c(2,2))
...
with(hpower, plot(Date, Voltage, type = 'l',
...
# Plot the upper-right graph
with(hpower, plot(Date, Global_reactive_power, type = 'l',
...
message('plot4.png generated in the working directory')